...
export const TCS = {
    ...
    modaleLink : "text-yellow-600 hover:bg-yellow-600 hover:text-lime-50 hover:decoration-none decoration-yellow-600 underline cursor-pointer hover:cursor-pointer",
    ...
    formInput : "block py-0 px-0 w-full font-sixtyfour text-[14px] text-amber-400 bg-transparent border-0 border-b-1 border-amber-400 appearance-none focus:outline-none focus:ring-0 focus:border-lime-50 peer [&:not(:placeholder-shown)]:border-lime-50 cursor-text",
